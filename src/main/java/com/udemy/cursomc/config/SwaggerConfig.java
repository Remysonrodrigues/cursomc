...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.udemy.cursomc.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
            ...
            new Contact("Remyson Rodrigues", "https://github.com/Remysonrodrigues", "remysonrodrigues@gmail.com"),
            "Permitido uso para estudo",
            "MIT",
